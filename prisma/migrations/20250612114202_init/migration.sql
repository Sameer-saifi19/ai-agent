...
-- CreateEnum
CREATE TYPE "AttendedTypeEnum" AS ENUM ('REGISTERED', 'ATTENDED', 'ADD_TO_CART', 'FOLLOW_UP', 'BREAKOUT_ROOM', 'CONVERTED');

-- CreateEnum
CREATE TYPE "callStatusEnum" AS ENUM ('PENDING', 'IN_PROGRESS', 'COMPLETED');
...
CREATE TABLE "Webinar" (
    ...
    "coupenEnabled" BOOLEAN NOT NULL DEFAULT false,
    "coupenExpiry" TIMESTAMP(3),
...
-- CreateIndex
CREATE UNIQUE INDEX "Attendance_webinarId_attendeeId_key" ON "Attendance"("webinarId", "attendeeId");
